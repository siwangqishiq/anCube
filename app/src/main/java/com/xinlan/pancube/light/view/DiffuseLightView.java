 ...
 *
 */
public class DiffuseLightView extends GLSurfaceView implements GLSurfaceView.Renderer {
    private Context context;

    public DiffuseLightView(Context context) {
        super(context);
        initView(context);
    }

    public DiffuseLightView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
