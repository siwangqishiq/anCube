...
public class RenderImageView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        mRenderProgram = OpenglEsUtils.buildShaderProgram(R.raw.render_image_vertex, R.raw.render_image_frg);
